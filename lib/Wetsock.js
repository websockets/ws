...
Wetsock.prototype.send = function(data, options) {
    ...
    var buf = frame(0x81, data, options && options.mask);
    try {
...
Wetsock.prototype.pong = function(data) {
    if (this._state != 'connected') throw 'not connected';
    var buf = frame(0x8a, data || '');
    try {
        this._socket.write(buf, 'binary');
    }
    catch (e) {
...
function frame(opcode, str, maskData) {
