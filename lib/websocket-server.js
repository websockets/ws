...
class WebSocketServer extends EventEmitter {
   ...
   * @return {Object} Returns the bound address, the address family name, and port of the server as reported by the operating system if listening on an IP socket
   * @public
   */
  address () {
