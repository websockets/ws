...
var readUInt16BE = /^v0\.4/.test(process.version) == false
...
var readUInt32BE = /^v0\.4/.test(process.version) == false
...
Receiver.prototype.allocateFromPool = /^v0\.4/.test(process.version) == false
