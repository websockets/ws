 ...
 * @param {function} Optional callback which is executed after the ping completes
 * @api public
 */
WebSocket.prototype.ping = function ping(data, options, dontFailWhenClosed, cb) {
  if (this.readyState !== WebSocket.OPEN) {
    if (dontFailWhenClosed === true) return;
    if (typeof dontFailWhenClosed === 'function')
      cb = dontFailWhenClosed;
